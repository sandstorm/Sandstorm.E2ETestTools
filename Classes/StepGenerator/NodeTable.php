...
class NodeTable
{
    ...
    {
        $this->_addNodesUnderneathExcludingAutoGeneratedChildNodes(
            $node,
            $nodeTypeFilter,
            $maxSiblings,
            $maxDepth,
    ...
    private function _addNodesUnderneathExcludingAutoGeneratedChildNodes(
        NodeInterface $node,
        $nodeTypeFilter,
        ?int $maxSiblings,
        ?int $maxDepth,
    ...
    ): void
    {
        ...
        foreach ($node->getChildNodes($nodeTypeFilter) as $childNode) {
            ...
            if ($maxSiblings !== null && $index > $maxSiblings) {
                break;
            }
        }
    }
